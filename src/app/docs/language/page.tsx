                                ...
                                <ul className="space-y-1">
                                    {section.items.map((item) => (
                                        <li key={item.href}>
                                            <Link
                                                href={item.href}
                                                className={`text-sm font-medium transition-colors block py-1 ${item.href === "/docs/language" ? "!text-primary font-bold" : "!text-slate-600 hover:!text-primary"}`}
                                            >
                                                {item.name}
                                            </Link>
                                        </li>
...
fn sum_first_n(x: Tensor<f32, 100>, n: i32) -> f32 {
    ...
    acc
                        ...
                        <p className="text-muted">
                            ...
                            <a href="https://github.com/cputer/mind-spec/blob/main/spec/v1.0/language.md" target="_blank" rel="noopener" className="text-primary hover:underline">
