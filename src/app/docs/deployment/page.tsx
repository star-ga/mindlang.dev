            ...
            <div className="flex gap-12">
                ...
                <main className="flex-1 min-w-0">
                    ...
                    <div className="prose prose-slate max-w-none">
                        ...
                        <CodeBlock
                            language="bash"
                            code={`# Build optimized inference binary
...
mind deploy model.bin --target aws --region us-east-1`}
                        ...
                        <CodeBlock
                            language="bash"
                            code={`# Generate Dockerfile and build image
...
mind deploy model.mind \\
    ...
    --gpu 1`}
                        ...
                        <CodeBlock
                            language="yaml"
                            code={`# Generated by: mind deploy --target kubernetes
apiVersion: apps/v1
kind: Deployment
metadata:
  name: my-model
        ...
        livenessProbe:
          httpGet:
            ...
            port: 8080`}
                        ...
                        <CodeBlock
                            language="rust"
                            code={`use mind::serve::{Server, Endpoint};
...
fn main() {
    Server::new()
        ...
        .serve();
                        ...
                        <CodeBlock
                            language="bash"
                            code={`# Build for ARM64 edge device
...
mind build --target wasm32 \\
    ...
    model.mind -o model.wasm`}
                        ...
                        <CodeBlock
                            language="bash"
                            code={`# Deploy new version with 10% traffic
...
mind deploy rollback`}
                        ...
                        <CodeBlock
                            language="rust"
                            code={`use mind::serve::{Server, Metrics};
