          ...
          <div className="grid grid--three">
            <div className="card">
              ...
              <div className="mt-4 p-3 bg-emerald-50 rounded-lg">
                ...
                <span className="text-emerald-600 text-sm block">Frontend: 35,000-176,000x faster than PyTorch GPU; 21,200-95,100x faster than JAX; 135,000-458,000x faster than Mojo</span>
